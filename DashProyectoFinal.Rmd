...
#Base filtrada y con categorias mutadas
...
tbl_plataforma = table(plataforma$Q11_Plataforma_Usada)
df_plataforma = data.frame(tbl_plataforma)
colnames(df_plataforma)=c("Plataformas","Total") 

#Grafica 

g_plataforma=plot_ly(df_plataforma, type = "bar",
                     x=df_plataforma$Plataformas,
                     y=df_plataforma$Total,
                     color = df_plataforma$Plataformas) %>% 
  layout(title="Plataforma usada", xaxis=list(title="Plataformas"))
```

### Tabla plataformas utilizadas
...
### Grafico de plataformas utilizdas 
